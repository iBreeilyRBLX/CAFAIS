...
function renderLogin() {
  ...
  `;
    document.getElementById('login-btn').onclick = () => {
        window.location.href = '/oauth/discord/start';
    };
}
        ...
        <div class="grid md:grid-cols-2 gap-4">
          <div class="bg-zinc-950 border-zinc-800 rounded-lg shadow p-6">
            ...
            <div class="flex items-center gap-3 mb-4">
              <img src="${((_a = user.roblox) === null || _a === void 0 ? void 0 : _a.avatar) || '/static/default-headshot.jpg'}" class="h-14 w-14 rounded-full bg-zinc-700" alt="Roblox Avatar" />
              <div>
                <p class="font-semibold">${((_b = user.roblox) === null || _b === void 0 ? void 0 : _b.displayName) || 'Not linked'}</p>
                <p class="text-sm text-gray-400">ID: ${((_c = user.roblox) === null || _c === void 0 ? void 0 : _c.id) || '-'}</p>
              </div>
            </div>
          ...
          <div class="bg-zinc-950 border-zinc-800 rounded-lg shadow p-6">
            ...
            <div class="flex items-center gap-3 mb-4">
              <img src="${((_d = user.discord) === null || _d === void 0 ? void 0 : _d.avatar) || '/static/default-headshot.jpg'}" class="h-14 w-14 rounded-full bg-zinc-700" alt="Discord Avatar" />
              <div>
                <p class="font-semibold">${((_e = user.discord) === null || _e === void 0 ? void 0 : _e.displayName) || 'Not linked'}</p>
                <p class="text-sm text-gray-400">ID: ${((_f = user.discord) === null || _f === void 0 ? void 0 : _f.id) || '-'}</p>
              </div>
            </div>
