...
export const containerRegistry: Record<number, () => ContainerBuilder> = {
    ...
    1: () => {
        ...
        const description = new TextDisplayBuilder()
            .setContent(
                'In order to gain access to the Applications Center to apply to become an Operative of TF1949, you\'ll need to verify your accounts.\n\n' +
                '**How to Verify:**\n' +
                'Click the "Verify Now" button below.\n\n' +
                '**After Verification, you\'ll gain access to:**\n' +
                '⁍ **Application Center** - Apply to Task Force or request other roles\n' +
                '⁍ **Applicant Chat** - Ask questions to NCO+ personnel about Task Force\n\n' +
