...
module.exports = {
  ...
  async execute(interaction: CommandInteraction) {
    ...
    let profile = await prisma.userProfile.findUnique({ where: { discordId } });
    if (!profile) {
      ...
      embeds: [
        {
          ...
          fields: [
            ...
            { name: 'Roblox User ID', value: profile.robloxUserId || 'Not linked', inline: true },
            { name: 'Roblox Username', value: profile.robloxUsername || 'Not linked', inline: true },
            { name: 'Roblox Display Name', value: profile.robloxDisplayName || 'Not linked', inline: true },
